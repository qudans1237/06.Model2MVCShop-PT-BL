	...
	<c:forEach var="product" items="${list}">
		...
		<td align="left">
					<c:choose>
						...
						구매완료 <a href="/updateTranCodeByProd.do?prodNo=${product.prodNo}&tranCode=002">배송하기</a>
						</c:when>
		...
		<td align="left">
					<c:choose>
						...
						<c:when test="${product.proTranCode eq '002'}">
						배송중 <a href="/updateTranCodeByProd.do?prodNo=${product.prodNo}&tranCode=003">상품받기</a>
						</c:when>
						<c:when test="${product.proTranCode eq '003'}">
						배송완료
						</c:when>
